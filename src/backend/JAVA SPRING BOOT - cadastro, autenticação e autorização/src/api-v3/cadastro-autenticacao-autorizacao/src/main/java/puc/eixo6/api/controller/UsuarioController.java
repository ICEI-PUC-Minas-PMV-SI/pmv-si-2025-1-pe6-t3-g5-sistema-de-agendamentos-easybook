...
public class UsuarioController {
    ...
    public Page<DadosListagemUsuarioPrestador> listarPrestadores(Pageable paginacao) {
        return repository.findAllByTipo("prestador", paginacao).map(DadosListagemUsuarioPrestador::new);
    }
